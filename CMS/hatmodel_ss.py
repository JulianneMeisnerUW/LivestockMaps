...
def main():
    ...
    model_description = build_model(**{
        "human-susceptible":2397-1654-574,
        "human-infectious-one":1654,
        "human-infectious-two":574,
        "tsetse-susceptible":2397*6.56*(1-0.006818574), #2 looks pretty good
        "tsetse-infectious":2397*6.56*0.006818574,
        "reservoir-susceptible":2397*0.02*(1-0.2847),
        "reservoir-infectious":2397*0.02*0.2847,
        "non-reservoir-hosts":2397/10})
    ...
    with Path("trajectories_ss.csv").open("w") as file:
...
def build_model(beta_h=0.0757, **kwargs):
    ...
    parameters = [
        ...
        {"name":"p-human-feed",     "value":0.089},      # probability of human feed
        #{"name":"p-human-feed",     "value":0.2},      # probability of human feed, just made-up, fit this
        ...
        {"name":"treatment-one",    "value":0.066255},      # probability a human is treated in stage 1
        {"name":"treatment-two",    "value":0.564745},      # probability a human is treated in stage 2
        # _not_ from the paper referenced above
        {"name":"p-feed",           "value":1.0/3},     # probability of feeding in a given 24 hours
        #{"name":"beta-h",           "value":0.0076},       # beta for human infection by infectious tsetse fly
        {"name":"beta-h",           "value":beta_h},       # beta for human infection by infectious tsetse fly. This one was just made-up, fit this
        {"name":"beta-r",           "value":0.1345},       # beta for reservoir infection by infectious tsetse fly
        {"name":"phi-r",            "value":0.142857143},    # reservoir incubation rate, swine
        ...
        {"name":"treatment-reservoir",          "value":0},     # probability reservoir is treated
