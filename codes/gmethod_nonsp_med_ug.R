...
if(species=="cattle"){
  save(file=paste0("gform_results/Uganda/gform_cattle_mean_med_", mediator, "_", type, ".Rdata"), results.mean)
  save(file=paste0("gform_results/Uganda/gform_cattle_total_med_",mediator, "_",type, ".Rdata"), results.total)
  save(file=paste0("gform_results/Uganda/gform_cattle_inc_med",mediator, "_",type, ".Rdata"), results.inc)
}else{
  save(file=paste0("gform_results/Uganda/gform_pigs_mean_med_",mediator, "_",type, ".Rdata"), results.mean)
  save(file=paste0("gform_results/Uganda/gform_pigs_total_med_",mediator, "_",type, ".Rdata"), results.total)
  save(file=paste0("gform_results/Uganda/gform_pigs_inc_med_",mediator, "_",type, ".Rdata"), results.inc)
}
