...
def main():
    ...
    model_description = build_model(**{
        "human-susceptible":15_082-10_790-3_744,
        "human-infectious-one":10_790,
        "human-infectious-two":3_744,
        "tsetse-susceptible":15_082*6.56*(1-0.024), #2 looks pretty good
        "tsetse-infectious":15_082*6.56*0.024,
        "reservoir-susceptible":15_082*0.06*(1-0.2847),
        "reservoir-infectious":15_082*0.06*0.2847,
        "non-reservoir-hosts":15_082/10})
    ...
    with Path("trajectories_drc_quan.csv").open("w") as file:
...
def build_model(beta_h=0.00967118640873665, **kwargs):
    ...
    parameters = [
        ...
        {"name":"p-human-feed",     "value":0.42},      # probability of human feed
